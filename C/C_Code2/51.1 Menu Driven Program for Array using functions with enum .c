...
enum meunchoice
{
	Exit=0, Accept_Array, Print_Array, Print_Rev, Array_Sum, Array_Max,Array_Max_Min, Array_Rev, Linear_Search, Seq_Search
};
typedef enum meunchoice MENUCHOICE;
...
int main( void )
{
	int arr[ SIZE ],  ans, ans1, find, *ptr=NULL;
	MENUCHOICE choice;
	...
	{
			ans= ans1=0;
			choice= (MENUCHOICE)MenuOperations();
			switch(choice)
			{
				default :
						printf("\n invalid case :: ");
				...
				case Accept_Array: // Accept Array elements
						printf("\n Enter Elements of array1 :: ");
						ReadArray(arr,SIZE);
						break;

				case Print_Array: // print all elements of array
						printf("\n Elements of array :: \n");
						PrintArray(arr, SIZE);
						break;

				case Print_Rev :// print rev
						printf("\n Elements of array :: \n");
						PrintArray(arr, SIZE);
						printf("\n Array in Rev :: ");
						PrintRev(arr, SIZE);
				...
				case Array_Max:// Max of array
						PrintArray(arr, SIZE);
						ans= ArrayMax(arr, SIZE);
						printf("\n Max of Array =%d",ans);
						break;
				case Array_Max_Min:// max min array
						PrintArray(arr, SIZE);
				...
				case Linear_Search://  find elements in array
						...
						break;
				case Seq_Search://  find elements in array return address
						printf("\n Enter Element to search :: ");
						scanf("%d", &find);
